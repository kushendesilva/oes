...
public class QuestionPanel extends JPanel implements ActionListener{
	...
	private void ResultManagement()
	{
			...
			questionAttempted.setBounds(10, 350, 244, 35);
			questionAttempted.setVisible(true);
			questionRemaining=new JLabel();
			questionRemaining.setBounds(10, 380, 244, 35);
			...
			try {
				if(rs.next())
				{
					...
					Previous.setFont(new Font("SansSerif", Font.BOLD, 16));
					Previous.setBounds(64, 310, 144, 35);
...
//									Next.setText("FIRST");
	...
	private void makeQuestionVisible(String q_id)
	{
		...
		questionAttempted.setText("Questions answered : "+q_attempted);
		questionRemaining.setText("Questions remaining : "+(qInfo.length-q_attempted));
		add(panel);
		...
		lblQXx.setFont(new Font("SansSerif", Font.BOLD, 13));
		...
		question_statement.setFont(new Font("SansSerif", Font.PLAIN, 14));
		question_statement.setForeground(Color.BLACK);
		question_statement.setBackground(Color.LIGHT_GRAY);
		...
		o_1.setFont(new Font("SansSerif", Font.PLAIN, 13));
		...
		o_2.setFont(new Font("SansSerif", Font.PLAIN, 13));
		...
		o_3.setFont(new Font("SansSerif", Font.PLAIN, 13));
		...
		o_4.setFont(new Font("SansSerif", Font.PLAIN, 13));
