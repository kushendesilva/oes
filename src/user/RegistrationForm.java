...
public class RegistrationForm extends JPanel implements ActionListener {
	...
	public RegistrationForm() {
		...
		COLLEGE.setFont(new Font("SansSerif", Font.PLAIN, 12));
		COLLEGE.setColumns(10);
		COLLEGE.setBounds(276, 305, 331, 20);
		add(COLLEGE);
		
		JLabel lblCollege = new JLabel("BATCH");
		...
		MOBILE.setFont(new Font("SansSerif", Font.PLAIN, 12));
		...
		LAST = new JTextField("");
		LAST.setFont(new Font("SansSerif", Font.PLAIN, 12));
		LAST.setColumns(10);
		LAST.setBounds(528, 157, 116, 20);
		add(LAST);
		
		MIDDLE = new JTextField("");
		MIDDLE.setFont(new Font("SansSerif", Font.PLAIN, 12));
		MIDDLE.setColumns(10);
		MIDDLE.setBounds(402, 157, 116, 20);
		add(MIDDLE);
		
		FIRST = new JTextField("");
		FIRST.setFont(new Font("SansSerif", Font.PLAIN, 12));
		FIRST.setColumns(10);
	...
	public RegistrationForm(EditDetails e) {
		...
		label_2.setBounds(558, 86, 242, 26);
		add(label_2);
		...
		submit.setBackground(new Color(0, 0, 0));
		submit.setFont(new Font("SansSerif", Font.BOLD, 16));
		submit.setBounds(623, 372, 116, 35);
		add(submit);
