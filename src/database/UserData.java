...
public class UserData extends JPanel{
	...
	public void makeGUI()
	{
		...
		lblRegDate.setFont(new Font("SansSerif", Font.BOLD, 13));
		...
		label_1.setBounds(222, 90, 85, 26);
		add(label_1);

		JLabel lblRegNo = new JLabel("ID : ");
		lblRegNo.setForeground(new Color(0, 0, 0));
		lblRegNo.setFont(new Font("SansSerif", Font.BOLD, 13));
		lblRegNo.setBounds(182, 90, 97, 26);
		add(lblRegNo);
		...
		JCOLLEGE.setFont(new Font("SansSerif", Font.PLAIN, 12));
		...
		lblCollege.setFont(new Font("SansSerif", Font.BOLD, 13));
		...
		year.setFont(new Font("SansSerif", Font.PLAIN, 12));
		...
		month.setFont(new Font("SansSerif", Font.PLAIN, 12));
		...
		JMOBILE.setFont(new Font("SansSerif", Font.PLAIN, 12));
		...
		JEMAIL.setFont(new Font("SansSerif", Font.PLAIN, 12));
		...
		other.setFont(new Font("SansSerif", Font.PLAIN, 10));
		...
		female.setFont(new Font("SansSerif", Font.PLAIN, 10));
		female.setBounds(339, 212, 73, 23);
		add(female);

		JRadioButton male = new JRadioButton("MALE");
		male.setEnabled(false);
		male.setFont(new Font("SansSerif", Font.PLAIN, 10));
		...
		JLAST.setFont(new Font("SansSerif", Font.PLAIN, 12));
		JLAST.setColumns(10);
		...
		JMIDDLE.setFont(new Font("SansSerif", Font.PLAIN, 12));
		...
		JFIRST.setFont(new Font("SansSerif", Font.PLAIN, 12));
		...
		JPASSWORD.setFont(new Font("SansSerif", Font.PLAIN, 12));
		...
		JUSERNAME.setFont(new Font("SansSerif", Font.PLAIN, 12));
		...
		JLabel lblOnlineExamination = new JLabel("STUDENT DETAILS");
