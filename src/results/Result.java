...
public class Result extends JPanel {
	...
	private Panel makeResult()
	{
		...
		lblSrno.setFont(new Font("SansSerif", Font.BOLD, 18));
		lblSrno.setBackground(SystemColor.WHITE);
		...
		for(int i=0;i<noOfCol;i++)
		{
			...
			lblColHead[i].setFont(new Font("SansSerif", Font.BOLD, 18));
			lblColHead[i].setBackground(SystemColor.WHITE);
