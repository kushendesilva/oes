...
public class EditCourse extends JPanel implements ItemListener{
	...
	public EditCourse(String courseName) {
		...
		updateEachMark.setFont(new Font("SansSerif", Font.BOLD, 13));
		...
		JLabel lblEachMark = new JLabel("Marks");
		...
		lblCourseName.setBounds(781, 113, 100, 24);
		add(lblCourseName);
		...
		chckbxHide.setFont(new Font("SansSerif", Font.BOLD, 16));
	...
	private JPanel New()
	{
		...
		New.setBackground(new Color(0, 255, 0));
		New.setLayout(null);
		...
		NqStatement.setFont(new Font("SansSerif", Font.PLAIN, 12));
		
		NqID = new JTextField();
		NqID.setBounds(182, 15, 147, 20);
		NqID.setFont(new Font("SansSerif", Font.PLAIN, 12));
		New.add(NqID);
		scrollPane.setViewportView(NqStatement);
		
		JLabel lblQuestionId = new JLabel(" Question ID : ");
		lblQuestionId.setBounds(10, 11, 165, 23);
		lblQuestionId.setFont(new Font("SansSerif", Font.BOLD, 13));
		New.add(lblQuestionId);
		
		JLabel lblQuestionStatement = new JLabel("Question : ");
		lblQuestionStatement.setFont(new Font("SansSerif", Font.BOLD, 13));
		lblQuestionStatement.setBounds(20, 46, 230, 23);
		New.add(lblQuestionStatement);
		
		JLabel lblOption = new JLabel("Answer 1");
		lblOption.setFont(new Font("SansSerif", Font.BOLD, 13));
		lblOption.setBounds(53, 231, 91, 23);
		New.add(lblOption);
		
		JLabel lblOption_1 = new JLabel("Answer 2");
		lblOption_1.setFont(new Font("SansSerif", Font.BOLD, 13));
		lblOption_1.setBounds(53, 265, 91, 23);
		New.add(lblOption_1);
		
		JLabel lblOption_2 = new JLabel("Answer 3");
		lblOption_2.setFont(new Font("SansSerif", Font.BOLD, 13));
		lblOption_2.setBounds(53, 299, 91, 23);
		New.add(lblOption_2);
		
		JLabel lblOption_3 = new JLabel("Answer 4");
		lblOption_3.setFont(new Font("SansSerif", Font.BOLD, 13));
		lblOption_3.setBounds(53, 333, 91, 23);
		New.add(lblOption_3);
		
		JLabel lblCorrectOption = new JLabel("Correct Answer : ");
		lblCorrectOption.setFont(new Font("SansSerif", Font.BOLD, 13));
		lblCorrectOption.setBounds(53, 380, 187, 23);
		New.add(lblCorrectOption);
		
		NcorrectOptionS = new JComboBox<String>();
		NcorrectOptionS.setFont(new Font("SansSerif", Font.PLAIN, 12));
		NcorrectOptionS.setModel(new DefaultComboBoxModel<String>(new String[] {"Answer-1", "Answer-2", "Answer-3", "Answer-4"}));
		...
		No1 = new JTextField();
		No1.setFont(new Font("SansSerif", Font.PLAIN, 12));
		No1.setBounds(154, 231, 560, 20);
		New.add(No1);
		
		No2 = new JTextField();
		No2.setFont(new Font("SansSerif", Font.PLAIN, 12));
		No2.setBounds(154, 269, 560, 20);
		New.add(No2);
		
		No3 = new JTextField();
		No3.setFont(new Font("SansSerif", Font.PLAIN, 12));
		No3.setBounds(154, 298, 560, 20);
		New.add(No3);
		
		No4 = new JTextField();
		No4.setFont(new Font("SansSerif", Font.PLAIN, 12));
	...
	private JPanel View()
	{
		...
		VcorrectOptionLabel.setFont(new Font("SansSerif", Font.BOLD, 13));
		...
		VqStatement.setFont(new Font("SansSerif", Font.PLAIN, 12));
		...
		Vo1 = new JTextField();
		Vo1.setFont(new Font("SansSerif", Font.PLAIN, 12));
		Vo1.setBounds(156, 232, 560, 20);
		View.add(Vo1);
		
		Vo2 = new JTextField();
		Vo2.setFont(new Font("SansSerif", Font.PLAIN, 12));
		Vo2.setBounds(156, 270, 560, 20);
		View.add(Vo2);
		
		Vo3 = new JTextField();
		Vo3.setFont(new Font("SansSerif", Font.PLAIN, 12));
		Vo3.setBounds(156, 299, 560, 20);
		View.add(Vo3);
		
		Vo4 = new JTextField();
		Vo4.setFont(new Font("SansSerif", Font.PLAIN, 12));
	...
	private JPanel Update()
	{
		...
		Update.setBackground(new Color(255, 251, 0));
		...
		UqStatement.setFont(new Font("SansSerif", Font.PLAIN, 12));
		...
		Uo1 = new JTextField();
		Uo1.setFont(new Font("SansSerif", Font.PLAIN, 12));
		...
		Uo2 = new JTextField();
		Uo2.setFont(new Font("SansSerif", Font.PLAIN, 12));
		...
		Uo3 = new JTextField();
		Uo3.setFont(new Font("SansSerif", Font.PLAIN, 12));
		...
		Uo4 = new JTextField();
		Uo4.setFont(new Font("SansSerif", Font.PLAIN, 12));
		...
		UcorrectOptionS.setFont(new Font("SansSerif", Font.PLAIN, 12));
	...
	private JPanel Remove()
	{
		...
		RcorrectOptionLabel.setFont(new Font("SansSerif", Font.PLAIN, 13));
		...
		RqStatement.setFont(new Font("SansSerif", Font.PLAIN, 13));
		...
		btnRemove.setFont(new Font("SansSerif", Font.BOLD, 16));
		btnRemove.setBounds(605, 381, 120, 37);
		Remove.add(btnRemove);
		
		Ro1 = new JTextField();
		Ro1.setFont(new Font("SansSerif", Font.PLAIN, 12));
		Ro1.setBounds(158, 232, 560, 20);
		Remove.add(Ro1);
		
		Ro2 = new JTextField();
		Ro2.setFont(new Font("SansSerif", Font.PLAIN, 12));
		Ro2.setBounds(158, 270, 560, 20);
		Remove.add(Ro2);
		
		Ro3 = new JTextField();
		Ro3.setFont(new Font("SansSerif", Font.PLAIN, 12));
